...
export const AdminSettings: React.FC = () => {
  ...
  const handleChangePinSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setPinSuccess('Admin Master PIN updated successfully!');
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Configure Master Admin authentication PIN and review system audit records</p>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-card p-6 sm:p-8 max-w-2xl">
        <div className="flex items-center gap-3 pb-6 border-b border-slate-100">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Enter a new 6-digit Master PIN and confirm</p>
          </div>
        </div>
